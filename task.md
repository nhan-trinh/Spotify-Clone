...
- [ ] **Phase 7: Quản Trị Viên & Kiểm duyệt Nội Dung (Admin & Moderator Panel)**
  - Moderator duyệt bài hát do Artist upload (Pending → Approved / Rejected).
  - Khóa tài khoản/Cảnh cáo user vi phạm nội dung (Strike system).
  - Admin Dashboard cơ bản quản lý File, User, Nghệ sĩ và các Role.

- [ ] **Phase 8: User Profile & Account Settings (Hồ sơ người dùng)**
...
- [ ] **Phase 9: Audio Processing Worker (FFmpeg & BullMQ)**
...
- [ ] **Phase 10: Tối Ưu Tìm Kiếm (Meilisearch Integration)**
...
- [ ] **Phase 11: Lời bài hát đồng bộ (Synced Lyrics)**
  - Hiển thị Lyrics tĩnh hoặc Lyrics đồng bộ chạy theo nhạc (Chỉ dành cho tài khoản Premium).

- [ ] **Phase 12: Thuật toán Gợi ý Nhạc (Discover Weekly)**
...
- [ ] **Phase 13: Gói Đăng Ký Premium (VNPAY)**
...
- [ ] **Phase 14: Tính Năng Xã Hội (Theo dõi Bạn Bè & Collaborative Playlist)**
